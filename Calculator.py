...
btn_clear.grid(row=6, column=1, columnspan=2)  # Corrected the typo here
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=11, font=("Arial", 15))  # Removed lambda as it's not necessary
btn_equals.grid(row=6, column=3, columnspan=2)  # Corrected the typo here
